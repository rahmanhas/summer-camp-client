            ...
            <div className='grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                {instructors.map((classItem) => (
                    <div className='' key={classItem._id}>
                        <img className='h-[300px] w-[300]' src={classItem.photoURL} alt=""/>
                        <h2 className='shadow-lg right-0 text-blue-600 flex justify-center items-center text-5xl font-extrabold uppercase'>{classItem.name}</h2>
